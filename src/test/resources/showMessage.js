...
__messageDiv.style.fontSize = '50px'; // 字体大小
...
// 创建关闭按钮 "X"
let __closeButton = document.createElement('span');
__closeButton.textContent = 'X';
__closeButton.style.position = 'absolute'; // 绝对定位
__closeButton.style.right = '20px'; // 距离右侧10pxw
__closeButton.style.fontSize = '50px'; // 字体大小
__closeButton.style.color = 'white'; // 文字颜色
__closeButton.style.cursor = 'pointer'; // 鼠标悬停时显示指针
__closeButton.style.zIndex = '10000'; // 确保按钮在 div 之上

// 将 文本内容 和关闭按钮添加到 div 中
__messageDiv.textContent = arguments[0]; // 设置 div 的内容
__messageDiv.appendChild(__closeButton); // 将关闭按钮添加到 div
